...
const Overview = () => {
  ...
  const weeklyData = [
    { day: "11 Sep", loggedHours: 0, weeklyOff: 8.5, lateBy: 0, absent: 0 },
    { day: "12", loggedHours: 0, weeklyOff: 0, lateBy: 0, absent: 0 },
    { day: "13", loggedHours: 0, weeklyOff: 0, lateBy: 0, absent: 0 },
    { day: "14", loggedHours: 0, weeklyOff: 8.5, lateBy: 0, absent: 0 },
    { day: "15", loggedHours: 0, weeklyOff: 0, lateBy: 0, absent: 8.5 },
    { day: "16", loggedHours: 0, weeklyOff: 0, lateBy: 0, absent: 0 },
    { day: "17", loggedHours: 0, weeklyOff: 8.5, lateBy: 0, absent: 0 }
  ];

  // Mock data for monthly view
  const monthlyData = [
    { week: "11 - 17 Aug", loggedHours: 45, weeklyOff: 20, lateBy: 0, absent: 0 },
    { week: "18 - 24 Aug", loggedHours: 55, weeklyOff: 5, lateBy: 0, absent: 0 },
    { week: "25 - 31 Aug", loggedHours: 55, weeklyOff: 5, lateBy: 3, absent: 0 },
    { week: "01 - 07 Sep", loggedHours: 55, weeklyOff: 5, lateBy: 2, absent: 0 },
    { week: "08 - 14 Sep", loggedHours: 60, weeklyOff: 5, lateBy: 0, absent: 0 }
  ];
    ...
    <DashboardLayout activeMenu="Overview">
      <div className="p-3 md:p-6 bg-gray-50 min-h-screen">
        ...
        <div className="mb-4 md:mb-6">
          <h1 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">Overview</h1>
          <p className="text-sm md:text-base text-gray-600">Track attendance metrics and performance</p>
        </div>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-sm font-medium text-blue-900 mb-1">Attendance Overview</h3>
              <p className="text-sm text-blue-700">
                This overview shows attendance metrics for your assigned trainees. 
                Use the dropdown to switch between weekly and monthly views. 
                The charts display logged hours, leave time, late arrivals, and absences.
              </p>
            </div>
          </div>
        </div>
